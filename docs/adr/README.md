...
Immutable records of load-bearing engineering decisions. Each ADR has: status,
context, decision, alternatives considered, consequences, and verification method.

...
Lazy Patta is a **platform**, not a single-game app. Every game is expressed
through the same [rule-pack framework](./game-design-framework.md) and the same
...
animations, accessibility, and test matrix.

...
interface PlayerPodProps {
  ...
  readonly seat: LalSattiSeatView;
  readonly compact?: boolean;
  readonly reaction?: { readonly kind: ReactionKind; readonly text: string } | null;
}

/**
 * A player seat around the table rim: avatar, localized name, cards-left badge,
 * animated active-turn ring, finished state, and an optional reaction bubble.
 * The ring is color-only, so an active pod also carries a textual "current turn"
